...
public class MainThread extends Thread {
    ...
    private SnakeGame.SnakeGameView snakeGameView;
     ...
     */
    public MainThread(SurfaceHolder surfaceHolder, SnakeGame.SnakeGameView view) {
        this.surfaceHolder = surfaceHolder;
        this.snakeGameView = view;
    }
        ...
        while (isRunning) {
            ...
            try {
                ...
                synchronized (surfaceHolder) {
                    this.snakeGameView.update();
                    this.snakeGameView.draw(canvas);
                }
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
